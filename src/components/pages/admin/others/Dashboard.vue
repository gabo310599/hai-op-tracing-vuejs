         ...
         <div class="card-body">
            ...
            <ul class="list-group">
               <li class="list-group-item list-group-item-danger" v-for="item in listDG" :key="item.id">
                  <a class="card-text font-weight-bold" data-toggle="modal" data-target="#DashboardModal"
                     v-on:click="fillModalInfo(item.id)">
                     {{ item.request }}
                  </a>
                  <p>
               ...
               <div>
                  <form>
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" id="dashboard/description_input" :value="modalData.description"
                           readonly>
                     </div>
