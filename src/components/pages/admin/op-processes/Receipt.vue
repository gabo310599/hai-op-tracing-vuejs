...
const initDataTable = async () => {
  ...
  dataTableProcess = $("#datatable_process_receipt").DataTable(dataTableOptions);
  dataTableHistory = $("#datatable_history_receipt").DataTable(dataTableOptions);
...
<template>
  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
        <table id="datatable_history_receipt" class="table table-striped">
          <thead>
            <tr>
              <th scope="col" class="center-text">#</th>
              <th scope="col" class="center-text">Nro. OP</th>
