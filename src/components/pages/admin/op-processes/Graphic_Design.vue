...
const initDataTable = async () => {
  ...
  dataTableCheckInProcess = $("#datatable_process_check_in_graphic_design").DataTable(dataTableCheckInProcessOptions);
...
<template>
  <h1 class="center-text font-weight-bold">Diseño Gráfico</h1>
  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
        <table id="datatable_process_check_in_graphic_design" class="table table-striped">
          <thead>
            <tr>
              <th scope="col" class="center-text">#</th>
              <th scope="col" class="center-text">Pedido</th>
