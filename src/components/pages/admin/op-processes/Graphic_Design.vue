...
const initDataTable = async () => {
  ...
  dataTableProcess = $("#datatable_process_graphic_design").DataTable(dataTableOptions);
  dataTableHistory = $("#datatable_history_graphic_design").DataTable(dataTableOptions);
