...
const initDataTable = async () => {
  ...
  dataTableProcess = $("#datatable_process_cuting").DataTable(dataTableOptions);
  dataTableHistory = $("#datatable_history_cuting").DataTable(dataTableOptions);
...
<template>
  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
        <table id="datatable_history_cuting" class="table table-striped">
          <thead>
            <tr>
              <th scope="col" class="center-text">#</th>
              <th scope="col" class="center-text">Nro. OP</th>
