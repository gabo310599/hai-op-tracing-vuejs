...
const initDataTable = async () => {
    ...
    dataTableProcess = $("#datatable_process_textile_design").DataTable(dataTableOptions);
    dataTableHistory = $("#datatable_history_textile_design").DataTable(dataTableOptions);
...
<template>
    {{ fillLists() }}
    <h1 class="center-text font-weight-bold">Diseño Textil</h1>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
                <table id="datatable_process_textile_design" class="table table-striped">
                    <thead>
                        <tr>
                        ...
                        <tr v-for="op in opListProcess" :key="op.key">
                            ...
                            <td class="center-text">
                                <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                    data-target="#processModal" v-on:click="fillModalInfo(op)">Información</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
                <table id="datatable_history_textile_design" class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col" class="center-text">#</th>
                            <th scope="col" class="center-text">Nro. OP</th>
                    ...
                    <tbody>
                        <tr v-for="op in opListHistory" :key="op.key">
                            ...
                            <td class="center-text">
                                <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                    data-target="#timeLineModal" v-on:click="fillSelectedOp(op)">Tracing
                                </button>
                            </td>
                        </tr>
                    </tbody>
