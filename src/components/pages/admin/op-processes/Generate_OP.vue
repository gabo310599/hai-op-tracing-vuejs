...
const initDataTable = async () => {
    ...
    dataTableProcess = $("#datatable_process_generate_op").DataTable(dataTableOptions);
    dataTableHistory = $("#datatable_history_generate_op").DataTable(dataTableOptions);
...
<template>
    ...
    {{ fillLists() }}
    <h1 class="center-text font-weight-bold">Generar OP</h1>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
                <table id="datatable_process_generate_op" class="table table-striped">
                    <thead>
                        <tr>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
                <table id="datatable_history_generate_op" class="table table-striped">
                    <thead>
                        <tr>
                            <th scope="col" class="center-text">#</th>
                            <th scope="col" class="center-text">Nro. OP</th>
