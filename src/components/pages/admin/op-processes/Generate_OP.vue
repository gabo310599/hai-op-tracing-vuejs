...
const initDataTable = async () => {
  ...
  dataTableProcess = $("#datatable_process_generate_op").DataTable(dataTableProcessOptions);
  dataTableCheckInProcess = $("#datatable_process_check_in_generate_op").DataTable(dataTableCheckInProcessOptions);
...
<template>
  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
        <table id="datatable_process_check_in_generate_op" class="table table-striped">
          <thead>
            <tr>
              <th scope="col" class="center-text">#</th>
              <th scope="col" class="center-text">Pedido</th>
