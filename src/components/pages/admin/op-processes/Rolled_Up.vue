...
const initDataTable = async () => {
  ...
  dataTableProcess = $("#datatable_process_rolled_up").DataTable(dataTableProcessOptions);
  dataTableCheckInProcess = $("#datatable_process_check_in_rolled_up").DataTable(dataTableCheckInProcessOptions);
...
<template>
  <h1 class="center-text font-weight-bold">Enrollado</h1>
  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
        <table id="datatable_process_rolled_up" class="table table-striped">
          <thead>
            <tr>
  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-xl-12 col-md-12">
        <table id="datatable_process_check_in_rolled_up" class="table table-striped">
          <thead>
            <tr>
              <th scope="col" class="center-text">#</th>
              <th scope="col" class="center-text">Pedido</th>
